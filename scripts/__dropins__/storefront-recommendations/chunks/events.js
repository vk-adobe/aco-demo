...
All Rights Reserved. */
import{events as S}from"@dropins/tools/event-bus.js";import{FetchGraphQL as C}from"@dropins/tools/fetch-graphql.js";const{setEndpoint:x,setFetchGraphQlHeader:q,removeFetchGraphQlHeader:A,setFetchGraphQlHeaders:K,fetchGraphQl:N,getConfig:Q}=new C().getMethods(),L=r=>{const e=r.map(n=>n.message).join(" ");throw new Error(e)},O=`query GetRecommendations(
  $pageType: PageType!
  $currentSku: String!
  $cartSkus: [String]
